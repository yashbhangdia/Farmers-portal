	...
	<nav class="navbar navbar-dark navbar-expand-lg fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="#">Krishi Mitra Logo</a>
        </div>
        <div class="navtoggle">
	...
	<div class="container-fluid footer">
		...
		<div class="row contact text-center text-md-left">
	        ...
	        <div class="col-md-3 pl-3 pt-4 text-center text-md-left mob">
	            <a href="#!" class="btn login mt-1" role="button">Sign In</a>
	            ...
	            <a href="#!" class="btn signup" role="button">Sign up!</a>
	        </div>
